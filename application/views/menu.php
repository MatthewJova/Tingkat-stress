  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="<?php echo base_url(); ?>index.php/Tes/" class="brand-link">
      <img src="<?= base_url('assets/images/logo1.jpg') ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">

      <span class="brand-text font-weight-light">Tes Tingkat Stress</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
